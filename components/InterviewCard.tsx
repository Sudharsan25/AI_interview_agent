      ...
      <div className="relative h-full bg-neutral-900 border border-white/10 rounded-2xl p-6 flex flex-col gap-6 hover:bg-neutral-800/50 transition-colors duration-300">
        ...
        <div className="flex items-start justify-between gap-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="text-xl font-bold text-white capitalize leading-tight">{role}</h3>
        ...
        <div className="space-y-3 flex-1">
           ...
           <div className="space-y-1.5">
              <span className="text-xs font-medium text-neutral-500 uppercase tracking-wider">Focus Area</span>
           ...
           <div className="space-y-2 pt-2">
             <div className="flex flex-wrap gap-2">
               {techArray.slice(0, 4).map((tech) => (
                 <Badge key={tech} variant="outline" className="bg-white/5 border-white/10 text-neutral-300 hover:bg-white/10">
                   {tech}
                 </Badge>
               ))}
               {techArray.length > 4 && (
                 <Badge variant="outline" className="bg-white/5 border-white/10 text-neutral-400">
                   +{techArray.length - 4}
                 </Badge>
               )}
             </div>
        ...
        <div className="pt-2 mt-auto">
          {completed ? (
            <Button className="w-full bg-neutral-800 text-neutral-400 cursor-not-allowed hover:bg-neutral-800" disabled>
              View Results
            </Button>
          ) : (
            <Dialog>
              ...
              <DialogContent className="bg-neutral-900 border-white/10 sm:max-w-md">
                ...
                <div className="py-6 text-neutral-300">
                  <p>
                    You are about to start a simulated interview session. 
                    Ensure you are in a quiet environment and have your microphone ready.
                  </p>
                ...
                <DialogFooter>
                  <DialogClose asChild>
                    <Link href={`/interview-start/${interviewId}`} className="w-full">
